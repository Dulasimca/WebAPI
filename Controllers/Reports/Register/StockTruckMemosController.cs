...
namespace TNCSCAPI.Controllers.Reports.Register
{
    ...
    [ApiController]
    public class StockTruckMemosController : ControllerBase
    {
        [HttpPost("{id}")]
        public string Post([FromBody] ReportParameter reportParameter)
        {
            ...
            ds = manageSQLConnection.GetDataSetValues("StockTruckMemoForRegister", sqlParameters);
            StockTruckMemoRegister stockDeliveryOrder = new StockTruckMemoRegister();
            ...
            if (manageReport.CheckDataAvailable(ds))
            {
                ...
                // stockDeliveryOrder.GenerateTruckMemoForRegister(entity);
                Task.Run(() => stockDeliveryOrder.GenerateTruckMemoForRegister(entity)); //Generate the Report
            }
