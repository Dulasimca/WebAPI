...
namespace TNCSCAPI.Controllers.Reports.DeliveryOrder
{
    ...
    [ApiController]
    public class DOSPLPDSController : ControllerBase
    {
        [HttpPost("{id}")]
        public string Post(DeliveryOrderSchemeWiseEntity SchemeWise)
        {
            ...
            ds = manageSQLConnection.GetDataSetValues("GetDeliveryOrderschemeSPLPDS", sqlParameters);
            ManageDOSPLPDS manageDOSPLPDS = new ManageDOSPLPDS();
            ...
            if (manageReport.CheckDataAvailable(ds))
            {
                ...
                Task.Run(() => manageDOSPLPDS.GenerateDOSPLPDSScheme(entity)); //Generate the Report
            }
