...
namespace TNCSCAPI.ManageAllReports.DeliveryOrder
{
    public class ManageDOOAP
    {
        ...
        public void GenerateDOOAPSchemeReport(CommonEntity entity)
        {
            ...
            try
            {
                fileName = entity.GCode + GlobalVariable.DOOAPReportFileName;
        ...
        public void AddHeader(StreamWriter sw, CommonEntity entity)
        {
            ...
            sw.WriteLine("        Godown : " + entity.GName + "Delivery Order Details Society Wise with Issue Details For OAP Scheme ");
