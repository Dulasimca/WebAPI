...
namespace TNCSCAPI.ManageAllReports.DeliveryOrder
{
    public class ManageDOOthers
    {
        ...
        public void GenerateDOOthersScheme(CommonEntity entity)
        {
            ...
            try
            {
                fileName = entity.GCode + GlobalVariable.DOOthersReportFileName;
                ...
                CommodityDOAllSchemeReport(streamWriter, entity);
        ...
        /// <param name="sw"></param>
        /// <param name="date"></param>
        public void AddCommodityHeader(StreamWriter sw, CommonEntity entity)
        {
            sw.WriteLine("   TAMILNADU CIVIL SUPPLIES CORPORATION          " + entity.RName);
            sw.WriteLine("   Godown : " + entity.GName + "Delivery Order Details Society Wise with Issue Details");
            sw.WriteLine("   D.Ord Date:" + report.FormatDate(entity.FromDate) + "           To : " + report.FormatDate(entity.Todate));
        ...
        /// <param name="sw"></param>
        /// <param name="entity"></param>
        public void CommodityDOAllSchemeReport(StreamWriter sw, CommonEntity entity)
        {
            int count = 10;
            ...
            {
                //dateList = entity.dataSet.Tables[0].DefaultView.ToTable(true, new string[] { "Coop", "Comodity" });
                var dateList = entity.dataSet.Tables[0].DefaultView.ToTable(true, "Comodity");
